...
This module defines the ShapeAlign class, which provides functionality to align,
analyze, and embed shape contours using preprocessing, Fourier transforms,
and PCA-based dimensionality reduction.

Dependencies:
- utils_contour.py for preprocessing routines
- utils_naive.py for morphological descriptors
"""
...
class ShapeAlign:
    ...
    def __str__(self):
        ...
        Includes:
        - Whether preprocessing has been done
